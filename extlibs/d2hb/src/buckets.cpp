...
d2hb::BlockManager::BlockManager(size_t bytes_per_entry) : m_bytes_per_entry(bytes_per_entry) {
...
BlockHandle BlockManager::allocate_block(Degree degree) {
    size_t const index = std::max(m_min_bsize_log2_ceiled, size_t(integer_log2_ceil(degree)));
