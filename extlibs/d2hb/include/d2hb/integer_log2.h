...
//! calculate the log2 floor of an integer type
static constexpr unsigned integer_log2_floor(int i) { return integer_log2_floor_template(i); }
...
//! calculate the log2 floor of an integer type
static constexpr unsigned integer_log2_floor(long i) { return integer_log2_floor_template(i); }
...
//! calculate the log2 floor of an integer type
static constexpr unsigned integer_log2_floor(long long i) { return integer_log2_floor_template(i); }
