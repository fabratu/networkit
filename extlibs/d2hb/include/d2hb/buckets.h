...
#endif // D2HB_SYSTEM_ALLOCATOR

class BlockManager {
  public:
    BlockManager(size_t bytes_per_entry);
...
#endif
    size_t m_min_bsize{2};
    size_t m_min_bsize_log2_ceiled = integer_log2_ceil(m_min_bsize);
};
