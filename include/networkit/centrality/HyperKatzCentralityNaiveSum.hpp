...
public:
    ...
    bool areDistinguished(index i, edgeid eid1, edgeid eid2) const;
...
private:
    void doIteration();
    bool checkConvergence(index i);
    bool checkGlobalConvergence();
    bool areSufficientlyRanked(index i, edgeid high, edgeid low) const;
    ...
    std::vector<std::vector<edgeid>> activeRanking;
